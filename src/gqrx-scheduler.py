...
def main():
    ...
    try:
        ...
        sys.stderr.write(f'Problems during schedule file read: {err}')
        exit(1)
    except KeyError as err:
        sys.stderr.write(f'Problems to detect the connection settings: {err}')
        exit(1)
    ...
    try:
        ...
        sys.stderr.write(f'Problem during schedule file read: {err}')
        exit(1)
    except KeyError as err:
        sys.stderr.write(f'Problem to detect setup commands: {err}')
        exit(1)
    except SchedParseExc as err:
        sys.stderr.write(f'Problem during task parsing: {err}')
        exit(1)
